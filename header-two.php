    ...
    <div class="side-menu">
        ...
        <header class="menu-header text-center">
            ...
            <div class="social-icon">
                <a class="facebook" target="_blank" href="https://facebook.com/habibjh88"><i class="fab fa-facebook"></i></a>
                <a class="twitter" target="_blank" href="https://twitter.com/habibjh88"><i class="fab fa-twitter"></i></a>
                <a class="linkedin" target="_blank" href="https://www.linkedin.com/in/habibjh88"><i class="fab fa-linkedin"></i></a>
