<?php
    ...
    function tt_theme_register_required_plugins() {
        ...
        $plugins = array(
            ...
            // Trendytheme Plugin
            array(
                'name'               => 'Maacuni Theme Plugin',
                // The plugin name
                'slug'               => 'tt-plugin',
                // The plugin slug (typically the folder name)
                'source'             => get_template_directory() . '/required-plugins/plugins/tt-plugin.zip',
                // The plugin source
                'required'           => TRUE,
            ...
            array(
                ...
                'slug'     => 'js_composer',
                // The plugin slug (typically the folder name)
                'source'   => get_template_directory() . '/required-plugins/plugins/js_composer.zip',
                // The plugin source
                'required' => TRUE
                // If false, the plugin is only 'recommended' instead of required
            ),
            ...
            array(
                ...
                'slug'     => 'revslider',
                // The plugin slug (typically the folder name)
                'source'   => get_template_directory() . '/required-plugins/plugins/revslider.zip',
                // The plugin source
                'required' => TRUE
                // If false, the plugin is only 'recommended' instead of required
            ),
